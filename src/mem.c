...
void *cmark_mem_calloc_typed(cmark_mem *mem, size_t count, size_t size, malloc_type_id_t type_id) {
  if (mem->calloc_typed)
...
void *cmark_mem_realloc_typed(cmark_mem *mem, void *ptr, size_t size, malloc_type_id_t type_id) {
